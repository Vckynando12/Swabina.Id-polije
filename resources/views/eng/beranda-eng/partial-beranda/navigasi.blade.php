        ...
        <ul class="navbar-nav mx-auto">
          ...
          <li class="nav-item dropdown position-relative">
            ...
            <ul class="dropdown-menu" aria-labelledby="navbarDropdown2" style="">
              ...
              <li><a class="dropdown-item" href="#" style="">Vision Mission and Culture</a></li>
              <li><a class="dropdown-item" href="#" style="">Certificates and Awards</a></li>
            </ul>
          </li>
          ...
          <li class="nav-item">
            <a class="nav-link me-5" id="nav-hamburger" href="#" >Ind</a> <!-- Add me-5 for margin -->
          </li>
