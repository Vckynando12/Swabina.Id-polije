...
@section('content')
<div class="container">
    <h1>Manage SWA Academy Carousel</h1>
    ...
    <table class="table mt-4">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <button class="btn btn-warning editBtn" data-id="{{ $carousel->id }}" 
                            data-image="{{ asset('storage/' . $carousel->image) }}" 
                            data-bs-toggle="modal" data-bs-target="#carouselModal">Edit</button>
            ...
            <form id="carouselForm" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <img id="previewImage" src="#" alt="Image Preview" style="max-width: 100%; margin-top: 10px; display: none;">
                    </div>
                </div>
...
<script>
    ...
    document.getElementById('carouselForm').addEventListener('submit', function(event) {
        ...
        var url = id ? `{{ route('admin.swaacademy.carouselSA.update', '') }}/${id}` : `{{ route('admin.swaacademy.carouselSA.store') }}`;
        ...
        btn.addEventListener('click', function() {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    fetch(`{{ route('admin.swaacademy.carouselSA.destroy', '') }}/${id}`, {
                        method: 'DELETE',
                        headers: {
                            'X-CSRF-TOKEN': '{{ csrf_token() }}'
                        }
