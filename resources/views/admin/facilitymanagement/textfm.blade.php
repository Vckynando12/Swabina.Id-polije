    ...
    <table class="table table-bordered">
        ...
        <tr>
            ...
            <td>
                ...
                <button class="btn btn-danger" onclick="confirmDelete('{{ route('admin.textfm.destroy', $text->id) }}')">Delete</button>
            </td>
        </tr>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="{{ route('admin.textfm.update', $text->id) }}" method="POST">
                            @csrf
                            @method('PUT')
                            <div class="form-group">
                                <label for="content{{ $text->id }}">Text:</label>
                                <textarea class="form-control" id="content{{ $text->id }}" name="content" rows="4" required style="white-space: pre-wrap;">{{ $text->content['id'] }}</textarea>
                            </div>
                            <div class="form-group">
    ...
    <div class="modal fade" id="addModal" tabindex="-1" role="dialog" aria-labelledby="addModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ route('admin.textfm.store') }}" method="POST">
                        @csrf
                        <div class="form-group">
